sap.ui.define([
	...
	return BaseController.extend("sap.btp.sapui5es5.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				AverageRating : function(oContext) {
					var iNumber = oContext.getProperty('AverageRating'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "sap.btp.sapui5es5.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("AverageRating", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("AverageRating", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
